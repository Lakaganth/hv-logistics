  ...
  return (
    <AdvantageBoxPage>
      ...
      <AdBoxAB
        ...
        AdContent="HV Logistics trustworthy real-time tracking shows the movement of your shipment and helps you to avoid any delays or missed transference. Our application enables you to receive real-time updates on the end-to-end tracking of your shipment as it travels downstream towards the destination"
      />
      <div className="advantage-4">
        <div className="content-div">
          ...
          <div className="content4">
            ...
            <p>
              HV Logistics diverse fleet options ensure your package is well
