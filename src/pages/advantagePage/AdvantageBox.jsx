      ...
      <div className="advantage-4">
        <div className="content-div">
          ...
          <div className="content4">
            ...
            <p>
              Stedfasts diverse fleet options ensure your package is well taken
              care of – regardless of your unique need. Our vehicle choices
              range from 10-ton truck to a car to give the right level of care
              and the fastest turnaround conceivable.
            </p>
          </div>
        </div>
